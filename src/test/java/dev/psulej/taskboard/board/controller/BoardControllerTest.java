...
class BoardControllerTest {
    ...
    void whenGetBoard_shouldReturn200StatusCode_andReturnBoard() throws Exception {
        ...
        User user1 = User.builder()
                ...
                .login("asmith")
                .name("Anna")
                .imageId(UUID.fromString("dd672f4b-ab70-4976-9d2d-db1f404bea87"))
                .avatarColor("#fad0c3")
                .build();
                            ...
                            "users": [
                                {
                                    ...
                                    "joinedAt": "2023-11-11T16:37:20.806Z"
                                },
                                {
                                    "user": {
                        ...
                        .content("""
                                {
                                    ...
                                    [
                                        {
                                        "userId" : "461c84d0-2233-433b-9784-4bf32cd81d6e",
                                        "role" : "BOARD_USER"
                                        },
                                         {
                                        "userId" : "99b65bfa-7120-11ee-b962-0242ac120002",
                                        "role" : "BOARD_USER"
                                        }
                                    ]
                                }
